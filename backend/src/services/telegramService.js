...
🔗 <a href="${process.env.FRONTEND_URL || 'https://freedomgroup.online'}">Перейти в личный кабинет</a>
...
🔗 <a href="${process.env.FRONTEND_URL || 'https://freedomgroup.online'}">Сайт партнерской системы</a>
    `.trim();
